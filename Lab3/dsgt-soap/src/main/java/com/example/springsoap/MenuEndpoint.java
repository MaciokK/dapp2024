...
public class MenuEndpoint {
    ...
    @PayloadRoot(namespace = NAMESPACE_URI, localPart = "getOrderMealRequest")
    @ResponsePayload
    public GetOrderMealResponse getOrderMeal(@RequestPayload GetOrderMealRequest request) {
        GetOrderMealResponse response = new GetOrderMealResponse();
        response.setMeal(mealrepo.orderMeal(request.getName(), request.getAddress()));
